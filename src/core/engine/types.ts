...
export enum DecisionAction {
  ...
  // v1.2 Memory governance actions
  /** Allow memory write */
  ...
  /** Deny memory read */
  DENY_READ = 'DENY_READ',
  /** Redact sensitive content then write to memory */
  REDACT_AND_WRITE = 'REDACT_AND_WRITE',
  /** Store summary-only representation in memory */
...
export enum ReasonCode {
  ...
  CREDENTIAL_TTL_EXCEEDED = 'CREDENTIAL_TTL_EXCEEDED',
  CREDENTIAL_ROTATION_REQUIRED = 'CREDENTIAL_ROTATION_REQUIRED',
  SECRET_SCAN_SKIPPED_PERF_BUDGET = 'SECRET_SCAN_SKIPPED_PERF_BUDGET',

  // v1.2 Memory
  MEMORY_WRITE_DENIED_SECRET = 'MEMORY_WRITE_DENIED_SECRET',
  MEMORY_WRITE_DENIED_PII = 'MEMORY_WRITE_DENIED_PII',
  MEMORY_WRITE_REDACTED = 'MEMORY_WRITE_REDACTED',
  MEMORY_WRITE_SUMMARY_ONLY = 'MEMORY_WRITE_SUMMARY_ONLY',
  MEMORY_SCOPE_VIOLATION = 'MEMORY_SCOPE_VIOLATION',
  MEMORY_READ_DENIED_CLASSIFICATION = 'MEMORY_READ_DENIED_CLASSIFICATION',
  MEMORY_WRITE_ALLOWED = 'MEMORY_WRITE_ALLOWED',
  MEMORY_READ_ALLOWED = 'MEMORY_READ_ALLOWED',
  MEMORY_READ_DENIED_SCOPE = 'MEMORY_READ_DENIED_SCOPE',
  MEMORY_ADAPTER_UNAVAILABLE = 'MEMORY_ADAPTER_UNAVAILABLE',
  MEMORY_TTL_REQUIRED = 'MEMORY_TTL_REQUIRED',
  MEMORY_TTL_EXCEEDED = 'MEMORY_TTL_EXCEEDED',
  ...
  PROVENANCE_SIGNATURE_MISSING = 'PROVENANCE_SIGNATURE_MISSING',
  PROVENANCE_VERIFICATION_FAILED = 'PROVENANCE_VERIFICATION_FAILED',
  SUPPLY_CHAIN_UNMAINTAINED = 'SUPPLY_CHAIN_UNMAINTAINED',
  SUPPLY_CHAIN_SCORE_LOW = 'SUPPLY_CHAIN_SCORE_LOW'
}
